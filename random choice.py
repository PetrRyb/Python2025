...
věci = ["kabát", "muffin", "chleba", "kaiserka", "mléko", "donut", "rajče", "řízek", "kuřecí nugety", "herní počítač"]
for i in věci:
    print(i)
nahodna_vec=random.choice(věci)    
nahodna_vec2 = random.choice(věci)
nahodna_vec3 = random.choice(věci)
nahodna_vec4 = random.choice(věci)
nahodna_vec5 = random.choice(věci)
nahodna_vec6 = random.choice(věci)
nahodna_vec7 = random.choice(věci)
nahodna_vec8 = random.choice(věci)
nahodna_vec9 = random.choice(věci)
nahodna_vec10 = random.choice(věci)
nahodna_vec11 = random.choice(věci)
nahodna_vec12 = random.choice(věci)
nahodna_vec13 = random.choice(věci)
nahodna_vec14 = random.choice(věci)
nahodna_vec15 = random.choice(věci)
nahodna_vec16 = random.choice(věci)
nahodna_vec17 = random.choice(věci)
nahodna_vec18 = random.choice(věci)
nahodna_vec19 = random.choice(věci)
nahodna_vec20 = random.choice(věci)
nahodna_vec21= random.choice(věci)
nahodna_vec22= random.choice(věci)
nahodna_vec23= random.choice(věci)
nahodna_vec24 = random.choice(věci)
nahodna_vec25 = random.choice(věci)
nahodna_vec26 = random.choice(věci)
